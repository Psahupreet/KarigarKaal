...
export default function PartnerDocuments() {
  ...
  const fetchPartners = () => {
    setIsLoading(true);
    axios
      .get("http://82.29.165.206:7001/api/admin/partner-documents", { withCredentials: true })
  ...
  const handleVerification = async (partnerId, action) => {
    try {
      ...
      const endpoint =
        action === "verify"
          ? `http://82.29.165.206:7001/api/admin/partners/${partnerId}/verify`
          : `http://82.29.165.206:7001/api/admin/partners/${partnerId}/decline`;
